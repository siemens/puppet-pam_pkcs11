...
describe 'pam_pkcs11' do
  ...
  context 'with default parameters' do
    ...
    describe file('/etc/pam_pkcs11/pam_pkcs11.conf') do
      ...
      its(:content) { is_expected.to match(default_pam_pkcs11_conf) }
    end
    ...
    context 'to a single, valid source' do
      ...
      if fact('os')['family'] == 'RedHat'
        ...
        describe file('/etc/pam_pkcs11/cacerts/cacert_class3.der') do
          ...
          it { is_expected.to be_grouped_into 'root' }
          it { is_expected.to be_mode '644' }
          its(:sha256sum) { is_expected.to eq '4edde9e55ca453b388887caa25d5c5c5bccf2891d73b87495808293d5fac83c8' }
        end
        ...
        describe file('/etc/pam_pkcs11/cacerts/cacert_class3.pem') do
          ...
          it { is_expected.to be_grouped_into 'root' }
          it { is_expected.to be_mode '644' }
          its(:sha256sum) { is_expected.to eq 'f5badaa5da1cc05b110a9492455a2c2790d00c7175dcf3a7bcb5441af71bf84f' }
        end
        ...
        describe file('/etc/pam_pkcs11/cacerts/cacert_root.der') do
          ...
          it { is_expected.to be_grouped_into 'root' }
          it { is_expected.to be_mode '644' }
          its(:sha256sum) { is_expected.to eq 'ff2a65cff1149c7430101e0f65a07ec19183a3b633ef4a6510890dad18316b3a' }
        end
        ...
        describe file('/etc/pam_pkcs11/cacerts/cacert_root.pem') do
          ...
          it { is_expected.to be_grouped_into 'root' }
          it { is_expected.to be_mode '644' }
          its(:sha256sum) { is_expected.to eq 'c0e0773a79dceb622ef6410577c19c1e177fb2eb9c623a49340de3c9f1de2560' }
        end
